...
class EditingToolsAdapter(
    ...
    tools: List<ToolType> = ToolType.values().toList(),
    ...
    init {
        for (tool in tools) {
            when (tool) {
                ...
                ToolType.STICKER -> mToolList.add(
                    ToolModel(
                        "Sticker",
